...
export default function About() {
  return (
    <div id="about" className="flex flex-col mx-4 h-[80vh] border-2 rounded-lg bg-slate-100 my-8 sm:mx-6 lg:mx-20 lg:mt-12 p-8 lg:px-40 xl:px-52">
      <h1 className='text-2xl font-semibold mx-auto md:text-3xl lg:text-5xl'>About Conference</h1>
      <p className='font-normal text-base text-justify mt-6 lg:mt-12 text-slate-600 md:text-xl'>
