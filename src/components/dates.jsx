export default function Dates() {
    return (
        <div id="dates" className="flex flex-col mx-4 h-[80vh] border-2 rounded-lg bg-slate-100 my-8 sm:mx-6 lg:mx-20 lg:mt-12 md:p-6 sm:p-2">
            <h1 className='text-xl font-semibold mx-auto md:text-2xl lg:text-3xl'>Dates</h1>
